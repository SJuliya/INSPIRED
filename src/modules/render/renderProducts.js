export const renderProducts = () => {
    const product = document.querySelector('.goods');
      ...
      <div class="container">
        ...
        <ul class="goods__list">
          <li class="goods__item">
            <article class="product">
              <a href="#" class="product__link">
                <img src="img/product01.jpg" alt="Бюстгальтер-Балконет Wien из Микрофибры" class="product__img">
                <h3 class="product__title">Бюстгальтер-Балконет Wien</h3>
              </a>
          ...
          <li class="goods__item">
            <article class="product">
              <a href="#" class="product__link">
                <img src="img/product02.jpg" alt="Бюстгальтер-Балконет Wien из Микрофибры" class="product__img">
